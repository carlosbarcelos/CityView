...
// var bikestationsTile = L.tileLayer('https://api.tiles.mapbox.com/v4/surv-mqp.793eadbr/{z}/{x}/{y}.png?access_token=pk.eyJ1Ijoic3Vydi1tcXAiLCJhIjoiY2o5eDNxZHRtN3hlMzJxbGcycm1kdjNkbCJ9.KbJcO99y-sr0o_x4zZMF0g', {
//   layers: 'Hubway_Stations-cw7igs',
//   format: 'image/png',
//   type: 'raster',
//   attribution: 'HubwayStation Data © <a href="https://www.thehubway.com/">The Hubway</a>',
//   transparent: true,
...
var map = L.map('mapid', {
  ...
  zoom: 12,
  layers: [streetView,streetlightsTile,bikestationsTile]
});
